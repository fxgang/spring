 ...
 * @className（类名称）: AccountServiceImpl01
 * @author（创建人）: 冯孝刚
 * @createDate（创建时间）: 2022-07-31 22:12
 * @version（版本）: v1.0
 */
...
public class AccountService01Impl implements IAccountService {
    private String name;
    private Integer age;
    ...
    public AccountService01Impl() {
        System.out.println("注解方式创建Bean实例成功... ...");
    }

    @Override
    public void saveAccount() {
        System.out.println("服务类开始保存数据... ...");
        //ad.saveAccount();
        //#region 稍后测试
        /*
