package com.newsoftdemo.day02.dao;
...
/**
 * @description（类描述）: 账户操作DAO接口
 * @projectName（项目名称）: newsoft
 * @package（包）: com.newsoftdemo.day02.dao
 * @className（类名称）: IAccount2Dao
 * @author（创建人）: 冯孝刚
 * @createDate（创建时间）: 2022-08-05 21:39
 * @version（版本）: v1.0
 */
public interface IAccount3Dao {
    /***
     * @description：获取账户列表
     * @author：冯孝刚
